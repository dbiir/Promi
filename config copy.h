...
#define MIGRATION_ALG LOCK

//DETEST Migration
#define PART_SPLIT_CNT 2
...
#define MAX_TXN_PER_PART 1000000 //每个节点最多生成query的数量
...
#define TXN_WRITE_PERC 0.7   //read
#define TUP_WRITE_PERC 0.3   //write
#define SCAN_PERC           0
#define SCAN_LEN          20
